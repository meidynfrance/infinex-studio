...
import { ExcelFormationForm } from "@/components/forms/ExcelFormationForm";

const rgb = "79,163,224";
const color = "var(--color-blue)";

export function ExcelFormationPage() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="relative z-10 mx-auto max-w-5xl px-4 pt-12 pb-16 sm:px-6 lg:px-8">
        ...
        >
          <ServiceIcon name="education" color={color} size={14} />
          {t("eyebrow")}
        </motion.div>
      ...
      <section id="inscription" className="relative z-10 mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.15 }}
          >
            <Suspense><ExcelFormationForm /></Suspense>
          </motion.div>
        </div>
      </section>
    </div>
